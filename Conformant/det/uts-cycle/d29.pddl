(define (domain uts_cycle_29)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 n14 n15 n16 n17 n18 n19 n20 n21 n22 n23 n24 n25 n26 n27 n28 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n28 ?label))
      (and  (at_node n28) (not (at_node n0)) (visited n28)))
    ...
    (when (and (at_node n28) (edge_label n28 n0 ?label))
      (and  (at_node n0) (not (at_node n28)) (visited n0)))
