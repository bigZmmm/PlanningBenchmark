(define (problem uts_cycle_5)
 ...
 (:init 
  ...
  (oneof
   (and (edge_label n0 n1 l1) (edge_label n0 n4 l2))
   (and (edge_label n0 n1 l2) (edge_label n0 n4 l1))
  )
  (oneof
  ...
  (oneof
   (and (edge_label n4 n0 l1) (edge_label n4 n3 l2))
   (and (edge_label n4 n0 l2) (edge_label n4 n3 l1))
  )
