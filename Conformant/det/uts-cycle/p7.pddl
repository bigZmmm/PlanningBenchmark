(define (problem uts_cycle_7)
 ...
 (:init 
  ...
  (oneof
   (and (edge_label n0 n1 l1) (edge_label n0 n6 l2))
   (and (edge_label n0 n1 l2) (edge_label n0 n6 l1))
  )
  (oneof
  ...
  (oneof
   (and (edge_label n6 n0 l1) (edge_label n6 n5 l2))
   (and (edge_label n6 n0 l2) (edge_label n6 n5 l1))
  )
