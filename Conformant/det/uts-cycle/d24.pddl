(define (domain uts_cycle_24)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 n14 n15 n16 n17 n18 n19 n20 n21 n22 n23 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n23 ?label))
      (and  (at_node n23) (not (at_node n0)) (visited n23)))
    ...
    (when (and (at_node n23) (edge_label n23 n0 ?label))
      (and  (at_node n0) (not (at_node n23)) (visited n0)))
