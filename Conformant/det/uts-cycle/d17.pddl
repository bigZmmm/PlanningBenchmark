(define (domain uts_cycle_17)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 n14 n15 n16 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n16 ?label))
      (and  (at_node n16) (not (at_node n0)) (visited n16)))
    ...
    (when (and (at_node n16) (edge_label n16 n0 ?label))
      (and  (at_node n0) (not (at_node n16)) (visited n0)))
