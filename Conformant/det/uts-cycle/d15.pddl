(define (domain uts_cycle_15)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 n14 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n14 ?label))
      (and  (at_node n14) (not (at_node n0)) (visited n14)))
    ...
    (when (and (at_node n14) (edge_label n14 n0 ?label))
      (and  (at_node n0) (not (at_node n14)) (visited n0)))
