(define (domain uts_cycle_16)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 n14 n15 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n15 ?label))
      (and  (at_node n15) (not (at_node n0)) (visited n15)))
    ...
    (when (and (at_node n15) (edge_label n15 n0 ?label))
      (and  (at_node n0) (not (at_node n15)) (visited n0)))
