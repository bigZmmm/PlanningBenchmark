(define (problem uts_cycle_10)
 ...
 (:init 
  ...
  (oneof
   (and (edge_label n0 n1 l1) (edge_label n0 n9 l2))
   (and (edge_label n0 n1 l2) (edge_label n0 n9 l1))
  )
  (oneof
  ...
  (oneof
   (and (edge_label n9 n0 l1) (edge_label n9 n8 l2))
   (and (edge_label n9 n0 l2) (edge_label n9 n8 l1))
  )
