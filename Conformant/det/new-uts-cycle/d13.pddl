(define (domain uts_cycle_13)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n12 ?label))
      (and  (at_node n12) (not (at_node n0)) (visited n12) (not (edge_label n0 n12 ?label))))
    ...
    (when (and (at_node n12) (edge_label n12 n0 ?label))
      (and  (at_node n0) (not (at_node n12)) (visited n0)))
