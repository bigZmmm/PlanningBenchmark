(define (domain uts_cycle_6)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n5 ?label))
      (and  (at_node n5) (not (at_node n0)) (visited n5) (not (edge_label n0 n5 ?label))))
    ...
    (when (and (at_node n5) (edge_label n5 n0 ?label))
      (and  (at_node n0) (not (at_node n5)) (visited n0)))
