(define (domain uts_cycle_12)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n11 ?label))
      (and  (at_node n11) (not (at_node n0)) (visited n11) (not (edge_label n0 n11 ?label))))
    ...
    (when (and (at_node n11) (edge_label n11 n0 ?label))
      (and  (at_node n0) (not (at_node n11)) (visited n0)))
