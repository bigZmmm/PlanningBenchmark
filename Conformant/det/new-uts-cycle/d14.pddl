(define (domain uts_cycle_14)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 n13 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n13 ?label))
      (and  (at_node n13) (not (at_node n0)) (visited n13) (not (edge_label n0 n13 ?label))))
    ...
    (when (and (at_node n7) (edge_label n7 n6 ?label))
      (and  (at_node n6) (not (at_node n7)) (visited n6) (not (edge_label n7 n6 ?label))))
    ...
    (when (and (at_node n8) (edge_label n8 n7 ?label))
      (and  (at_node n7) (not (at_node n8)) (visited n7) (not (edge_label n8 n7 ?label))))
    ...
    (when (and (at_node n9) (edge_label n9 n8 ?label))
      (and  (at_node n8) (not (at_node n9)) (visited n8) (not (edge_label n9 n8 ?label))))
    ...
    (when (and (at_node n10) (edge_label n10 n9 ?label))
      (and  (at_node n9) (not (at_node n10)) (visited n9) (not (edge_label n10 n9 ?label))))
    ...
    (when (and (at_node n11) (edge_label n11 n10 ?label))
      (and  (at_node n10) (not (at_node n11)) (visited n10) (not (edge_label n11 n10 ?label))))
    ...
    (when (and (at_node n12) (edge_label n12 n11 ?label))
      (and  (at_node n11) (not (at_node n12)) (visited n11) (not (edge_label n12 n11 ?label))))
    (when (and (at_node n13) (edge_label n13 n0 ?label))
      (and  (at_node n0) (not (at_node n13)) (visited n0)))
    (when (and (at_node n13) (edge_label n13 n12 ?label))
      (and  (at_node n12) (not (at_node n13)) (visited n12) (not (edge_label n13 n12 ?label))))
   ))
 )
