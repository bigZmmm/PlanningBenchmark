(define (domain uts_cycle_11)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n10 ?label))
      (and  (at_node n10) (not (at_node n0)) (visited n10) (not (edge_label n0 n10 ?label))))
    ...
    (when (and (at_node n10) (edge_label n10 n0 ?label))
      (and  (at_node n0) (not (at_node n10)) (visited n0)))
