 ...
 (:predicates
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n3 ?label))
      (and  (at_node n3) (not (at_node n0)) (visited n3) (not (edge_label n0 n3 ?label))))
    ...
    (when (and (at_node n3) (edge_label n3 n0 ?label))
      (and  (at_node n0) (not (at_node n3)) (visited n0) ))
