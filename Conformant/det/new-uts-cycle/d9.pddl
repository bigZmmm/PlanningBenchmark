 ...
 (:predicates
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n8 ?label))
      (and  (at_node n8) (not (at_node n0)) (visited n8) (not (edge_label n0 n8 ?label))))
    ...
    (when (and (at_node n8) (edge_label n8 n0 ?label))
      (and  (at_node n0) (not (at_node n8)) (visited n0)))
