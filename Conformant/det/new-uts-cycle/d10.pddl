(define (domain uts_cycle_10)
 (:requirements :typing :conditional-effects)
 (:types node label)
 (:constants  n0 n1 n2 n3 n4 n5 n6 n7 n8 n9 - node)
 (:predicates
	(visited ?n - node)
  ...
  (:action follow_label
   ...
   (and 
    ...
    (when (and (at_node n0) (edge_label n0 n9 ?label))
      (and  (at_node n9) (not (at_node n0)) (visited n9) (not (edge_label n0 n9 ?label))))
    ...
    (when (and (at_node n9) (edge_label n9 n0 ?label))
      (and  (at_node n0) (not (at_node n9)) (visited n0)))
