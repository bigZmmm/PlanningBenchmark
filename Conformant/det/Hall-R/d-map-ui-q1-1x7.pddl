(define (domain hall-rotate)
  ...
  (:action zoom
    :effect (and (when (and (x-agent p1) (y-agent p1) (north)) (obsAW))
                 ...
                 (when (and (x-agent p7) (y-agent p1) (north)) (obsBW))
                 (when (and (x-agent p7) (y-agent p1) (east)) (obsBW))
                 (when (and (x-agent p7) (y-agent p1) (south)) (obsBW))
                 (when (and (x-agent p7) (y-agent p1) (west)) (obsB-))
