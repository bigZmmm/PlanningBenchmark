(define (domain raos_keys)
 ...
 (:constants  k0 k1 k2 k3 k4 k5 k6 k7 k8 k9 - key)
 ...
 (:action search_under_light
  ...
  :effect (and
		...
		(when (and (open ?l) (key_at k7 ?l)) (have_key k7))
		(when (and (open ?l) (key_at k8 ?l)) (have_key k8))
		(when (and (open ?l) (key_at k9 ?l)) (have_key k9))
          )
 )
 (:action goto_light
