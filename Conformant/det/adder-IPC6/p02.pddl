(define (problem p2)
  (:domain adder)
  (:objects t f t1 t2 t3 t4 t5 x1 y1 r1 z1 x2 y2 r2 z2 r3 z3 - bit)
  (:init  (high t) (low f)
              (low r1) (low r2) (low r3) 
              (low z1) (low z2) (low z3) 
              (low t1) (low t2) (low t3) (low t4) (low t5)
	      ...
	      (constant r1) 	
              (constant t)
              (constant f)
              (in x1) (in x2) (in y1) (in y2) (in r1) 
	      (out z1) (out z2) (out r3)
        )
  
  (:goal (and (low r1)
	      (constant z1) (constant z2) 
	      (constant r1) (constant r2) (constant r3)
              (or (low z3) (high r3))
              (or (low r3) (high z3))
