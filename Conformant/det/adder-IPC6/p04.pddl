(define (problem p4)
  (:domain adder)
  (:objects t f t1 t2 t3 t4 t5 t6 t7 t8 t9 t10 t11 x1 y1 r1 z1 x2 y2 r2 z2 x3 y3 r3 z3 x4 y4 r4 z4 r5 z5 - bit)
  (:init  (high t) (low f)
	      ...
	      (constant r1) 	
              (constant t)
              (constant f)
              (in x1) (in x2) (in x3) (in x4) (in y1) (in y2) (in y3) (in y4) (in r1) 
	      (out z1) (out z2) (out z3) (out z4) (out r5) 
        )
  
  (:goal (and (low r1)
	      (constant z1) (constant z2) (constant z3) (constant z4) (constant z5)
	      (constant r1) (constant r2) (constant r3) (constant r4) (constant r5)
              (or (low z5) (high r5))
              (or (low r5) (high z5))
