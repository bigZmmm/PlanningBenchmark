(define (problem p3)
  (:domain adder)
  (:objects t f t1 t2 t3 t4 t5 t6 t7 t8 x1 y1 r1 z1 x2 y2 r2 z2 x3 y3 r3 z3 r4 z4 - bit)
  (:init  (high t) (low f)
              (low r1) (low r2) (low r3) (low r4) 
              (low z1) (low z2) (low z3) (low z4) 
              (low t1) (low t2) (low t3) (low t4) (low t5) (low t6) (low t7) (low t8)
	      ...
	      (constant r1) 	
              (constant t)
              (constant f)
              (in x1) (in x2) (in x3) (in y1) (in y2) (in y3) (in r1) 
	      (out z1) (out z2) (out z3) (out z4) (out r4) 
        )
  
  (:goal (and (low r1)
	      (constant z1) (constant z2) (constant z3) (constant z4)
	      (constant r1) (constant r2) (constant r3) (constant r4)
              (or (low z4) (high r4))
              (or (low r4) (high z4))
