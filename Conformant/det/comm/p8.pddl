(define (problem comm_12_9)
  (:domain comm)
  (:objects s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 - stage p0 p1 p2 p3 p4 p5 p6 p7 p8 - packet)
  ...
  (:goal (and (ok p0) (ok p1) (ok p2) (ok p3) (ok p4) (ok p5) (ok p6) (ok p7) (ok p8)))
)
