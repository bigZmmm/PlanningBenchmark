(define (domain forest)
  ...
  (:constants
     x1 y1 x2 y2 x3 y3 x4 y4 x5 y5 x6 y6 x7 y7 x8 y8 x9 y9 - location
  ...
  (:action up_x
   :effect (and
	...
	(when (and (at x2) (solved x2)) 
        (and (not (at x2)) (at x3)))
	(when (and (at x3) (solved x3)) 
        (and (not (at x3)) (at x4)))
	(when (and (at x4) (solved x4)) 
        (and (not (at x4)) (at x5)))
	(when (and (at x5) (solved x5)) 
        (and (not (at x5)) (at x6)))
	(when (and (at x6) (solved x6)) 
        (and (not (at x6)) (at x7)))
	(when (and (at x7) (solved x7)) 
        (and (not (at x7)) (at x8)))
	(when (and (at x8) (solved x8)) 
        (and (not (at x8)) (at x9)))
  ))
  ...
  (:action up_y
   :effect (and
	...
	(when (and (at y2) (solved y2)) 
        (and (not (at y2)) (at y3)))
	(when (and (at y3) (solved y3)) 
        (and (not (at y3)) (at y4)))
	(when (and (at y4) (solved y4)) 
        (and (not (at y4)) (at y5)))
	(when (and (at y5) (solved y5)) 
        (and (not (at y5)) (at y6)))
	(when (and (at y6) (solved y6)) 
        (and (not (at y6)) (at y7)))
	(when (and (at y7) (solved y7)) 
        (and (not (at y7)) (at y8)))
	(when (and (at y8) (solved y8)) 
        (and (not (at y8)) (at y9)))
 ))
  (:action down_x
   :effect (and
	(when (and (at x9) (solved x9)) 
        (and (not (at x9)) (at x8)))
	(when (and (at x8) (solved x8)) 
        (and (not (at x8)) (at x7)))
	(when (and (at x7) (solved x7)) 
