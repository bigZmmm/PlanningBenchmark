(define (domain grid)
   ...
   (:types num )
   (:constants zero one two three four five six seven eight nine ten eleven twelve thirteen fourteen fifteen sixteen seventeen eighteen  -num)
   (:predicates (x ?i - num) (y ?i - num) (canmove))

   (:action can_move
      :parameters()
      :effect (and
		(when(and (x fifteen) (y six)) (not (canmove)))
		(when(not (and (x fifteen) (y six))) (canmove))
   ...
   (:action north
      ...
      :effect (and
		...
		(when (and (y fourteen) (canmove)) (and (y thirteen) (not (y fourteen))))
		(when (and (y fifteen) (canmove)) (and (y fourteen) (not (y fifteen))))
		(when (and (y sixteen) (canmove)) (and (y fifteen) (not (y sixteen))))
		(when (and (y seventeen) (canmove)) (and (y sixteen) (not (y seventeen))))
		(when (and (y eighteen) (canmove)) (and (y seventeen) (not (y eighteen))))
   ...
   (:action south
      ...
      :effect (and
		...
		(when (and (y thirteen) (canmove)) (and (y fourteen) (not (y thirteen))))
		(when (and (y fourteen) (canmove)) (and (y fifteen) (not (y fourteen))))
		(when (and (y fifteen) (canmove)) (and (y sixteen) (not (y fifteen))))
		(when (and (y sixteen) (canmove)) (and (y seventeen) (not (y sixteen))))
		(when (and (y seventeen) (canmove)) (and (y eighteen) (not (y seventeen))))
   ...
   (:action east
      ...
      :effect (and
		...
		(when (and (x thirteen) (canmove)) (and (x fourteen) (not (x thirteen))))
		(when (and (not (y six)) (x fourteen) (canmove)) (and (x fifteen) (not (x fourteen))))
		(when (and (x fifteen) (canmove)) (and (x sixteen) (not (x fifteen))))
		(when (and (x sixteen) (canmove)) (and (x seventeen) (not (x sixteen))))
		(when (and (x seventeen) (canmove)) (and (x eighteen) (not (x seventeen))))
   ...
   (:action west
      ...
      :effect (and
		...
		(when (and (x fourteen) (canmove)) (and (x thirteen) (not (x fourteen))))
		(when (and (x fifteen) (canmove)) (and (x fourteen) (not (x fifteen))))
		(when (and (x sixteen) (canmove)) (and (x fifteen) (not (x sixteen))))
		(when (and (x seventeen) (canmove)) (and (x sixteen) (not (x seventeen))))
		(when (and (x eighteen) (canmove)) (and (x seventeen) (not (x eighteen))))
