(define (domain grid)
   ...
   (:types num )
   (:constants zero one two three four five six seven eight nine ten eleven twelve thirteen fourteen fifteen sixteen seventeen eighteen nineteen  -num)
   (:predicates (x ?i - num) (y ?i - num) (canmove))

   (:action can_move
      :parameters()
      :effect (and
		(when(and (x sixteen) (y six)) (not (canmove)))
		(when(not (and (x sixteen) (y six))) (canmove))
   ...
   (:action north
      ...
      :effect (and
		...
		(when (and (y nineteen) (canmove)) (and (y eighteen) (not (y nineteen))))
   ...
   (:action south
      ...
      :effect (and
		...
		(when (and (y eighteen) (canmove)) (and (y nineteen) (not (y eighteen))))
   ...
   (:action east
      ...
      :effect (and
		...
		(when (and (not (y six)) (x fifteen) (canmove)) (and (x sixteen) (not (x fifteen))))
		(when (and (x sixteen) (canmove)) (and (x seventeen) (not (x sixteen))))
		(when (and (x seventeen) (canmove)) (and (x eighteen) (not (x seventeen))))
		(when (and (x eighteen) (canmove)) (and (x nineteen) (not (x eighteen))))
   ...
   (:action west
      ...
      :effect (and
		...
		(when (and (x nineteen) (canmove)) (and (x eighteen) (not (x nineteen))))
