...
(define (domain d-ring-31)
  (:requirements :typing :equality)
  (:types window)
  (:constants  w1  w2  w3  w4  w5  w6  w7  w8  w9  w10  w11  w12  w13  w14  w15  w16  w17  w18  w19  w20  w21  w22  w23  w24  w25  w26  w27  w28  w29  w30  w31  - window)
  (:predicates
     (pos ?w - window)
     (closed ?w - window)
     (open ?w - window)
  ...
  (:action fwd
     :effect
       (and 
            ...
            (when (pos w31) (and (pos w1) (not (pos w31))))  
       )
  )
  (:action bwd
     :effect
       (and 
            (when (pos w1) (and (pos w31) (not (pos w1))))  
