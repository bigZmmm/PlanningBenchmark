...
(define (domain d-ring-13)
  (:requirements :typing :equality)
  (:types window)
  (:constants  w1  w2  w3  w4  w5  w6  w7  w8  w9  w10  w11  w12  w13  - window)
  (:predicates
     (pos ?w - window)
     (closed ?w - window)
     (open ?w - window)
  ...
  (:action fwd
     :effect
       (and 
            ...
            (when (pos w13) (and (pos w1) (not (pos w13))))  
       )
  )
  (:action bwd
     :effect
       (and 
            (when (pos w1) (and (pos w13) (not (pos w1))))  
