...
(define (domain d-ring-17)
  (:requirements :typing :equality)
  (:types window)
  (:constants  w1  w2  w3  w4  w5  w6  w7  w8  w9  w10  w11  w12  w13  w14  w15  w16  w17  - window)
  (:predicates
     (pos ?w - window)
     (closed ?w - window)
     (open ?w - window)
  ...
  (:action fwd
     :effect
       (and 
            ...
            (when (pos w17) (and (pos w1) (not (pos w17))))  
       )
  )
  (:action bwd
     :effect
       (and 
            (when (pos w1) (and (pos w17) (not (pos w1))))  
