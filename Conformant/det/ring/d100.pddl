...
(define (domain d-ring-100)
  (:requirements :typing :equality)
  (:types window)
  (:constants  w1  w2  w3  w4  w5  w6  w7  w8  w9  w10  w11  w12  w13  w14  w15  w16  w17  w18  w19  w20  w21  w22  w23  w24  w25  w26  w27  w28  w29  w30  w31  w32  w33  w34  w35  w36  w37  w38  w39  w40  w41  w42  w43  w44  w45  w46  w47  w48  w49  w50  w51  w52  w53  w54  w55  w56  w57  w58  w59  w60  w61  w62  w63  w64  w65  w66  w67  w68  w69  w70  w71  w72  w73  w74  w75  w76  w77  w78  w79  w80  w81  w82  w83  w84  w85  w86  w87  w88  w89  w90  w91  w92  w93  w94  w95  w96  w97  w98  w99  w100  - window)
  (:predicates
     (pos ?w - window)
     (closed ?w - window)
     (open ?w - window)
  ...
  (:action fwd
     :effect
       (and 
            ...
            (when (pos w76) (and (pos w77) (not (pos w76))))  
            (when (pos w77) (and (pos w78) (not (pos w77))))  
            (when (pos w78) (and (pos w79) (not (pos w78))))  
            (when (pos w79) (and (pos w80) (not (pos w79))))  
            (when (pos w80) (and (pos w81) (not (pos w80))))  
            (when (pos w81) (and (pos w82) (not (pos w81))))  
            (when (pos w82) (and (pos w83) (not (pos w82))))  
            (when (pos w83) (and (pos w84) (not (pos w83))))  
            (when (pos w84) (and (pos w85) (not (pos w84))))  
            (when (pos w85) (and (pos w86) (not (pos w85))))  
            (when (pos w86) (and (pos w87) (not (pos w86))))  
            (when (pos w87) (and (pos w88) (not (pos w87))))  
            (when (pos w88) (and (pos w89) (not (pos w88))))  
            (when (pos w89) (and (pos w90) (not (pos w89))))  
            (when (pos w90) (and (pos w91) (not (pos w90))))  
            (when (pos w91) (and (pos w92) (not (pos w91))))  
            (when (pos w92) (and (pos w93) (not (pos w92))))  
            (when (pos w93) (and (pos w94) (not (pos w93))))  
            (when (pos w94) (and (pos w95) (not (pos w94))))  
            (when (pos w95) (and (pos w96) (not (pos w95))))  
            (when (pos w96) (and (pos w97) (not (pos w96))))  
            (when (pos w97) (and (pos w98) (not (pos w97))))  
            (when (pos w98) (and (pos w99) (not (pos w98))))  
            (when (pos w99) (and (pos w100) (not (pos w99))))  
            (when (pos w100) (and (pos w1) (not (pos w100))))  
       )
  )
  (:action bwd
     :effect
       (and 
            (when (pos w1) (and (pos w100) (not (pos w1))))  
            ...
            (when (pos w77) (and (pos w76) (not (pos w77))))  
            (when (pos w78) (and (pos w77) (not (pos w78))))  
            (when (pos w79) (and (pos w78) (not (pos w79))))  
            (when (pos w80) (and (pos w79) (not (pos w80))))  
            (when (pos w81) (and (pos w80) (not (pos w81))))  
            (when (pos w82) (and (pos w81) (not (pos w82))))  
            (when (pos w83) (and (pos w82) (not (pos w83))))  
            (when (pos w84) (and (pos w83) (not (pos w84))))  
            (when (pos w85) (and (pos w84) (not (pos w85))))  
            (when (pos w86) (and (pos w85) (not (pos w86))))  
            (when (pos w87) (and (pos w86) (not (pos w87))))  
            (when (pos w88) (and (pos w87) (not (pos w88))))  
            (when (pos w89) (and (pos w88) (not (pos w89))))  
            (when (pos w90) (and (pos w89) (not (pos w90))))  
            (when (pos w91) (and (pos w90) (not (pos w91))))  
            (when (pos w92) (and (pos w91) (not (pos w92))))  
            (when (pos w93) (and (pos w92) (not (pos w93))))  
            (when (pos w94) (and (pos w93) (not (pos w94))))  
            (when (pos w95) (and (pos w94) (not (pos w95))))  
            (when (pos w96) (and (pos w95) (not (pos w96))))  
            (when (pos w97) (and (pos w96) (not (pos w97))))  
            (when (pos w98) (and (pos w97) (not (pos w98))))  
            (when (pos w99) (and (pos w98) (not (pos w99))))  
            (when (pos w100) (and (pos w99) (not (pos w100))))  
       )
  )
  (:action close
     :effect
       (and  
            ...
            (when (and (open w77) (pos w77)) (closed w77))  
            (when (and (open w78) (pos w78)) (closed w78))  
            (when (and (open w79) (pos w79)) (closed w79))  
            (when (and (open w80) (pos w80)) (closed w80))  
            (when (and (open w81) (pos w81)) (closed w81))  
            (when (and (open w82) (pos w82)) (closed w82))  
            (when (and (open w83) (pos w83)) (closed w83))  
            (when (and (open w84) (pos w84)) (closed w84))  
            (when (and (open w85) (pos w85)) (closed w85))  
            (when (and (open w86) (pos w86)) (closed w86))  
            (when (and (open w87) (pos w87)) (closed w87))  
            (when (and (open w88) (pos w88)) (closed w88))  
            (when (and (open w89) (pos w89)) (closed w89))  
            (when (and (open w90) (pos w90)) (closed w90))  
            (when (and (open w91) (pos w91)) (closed w91))  
            (when (and (open w92) (pos w92)) (closed w92))  
            (when (and (open w93) (pos w93)) (closed w93))  
            (when (and (open w94) (pos w94)) (closed w94))  
            (when (and (open w95) (pos w95)) (closed w95))  
            (when (and (open w96) (pos w96)) (closed w96))  
            (when (and (open w97) (pos w97)) (closed w97))  
            (when (and (open w98) (pos w98)) (closed w98))  
            (when (and (open w99) (pos w99)) (closed w99))  
            (when (and (open w100) (pos w100)) (closed w100))  
       )
  )
  (:action lock
     :effect
       (and 
            ...
            (when (and (pos w77) (closed w77)) (locked w77))  
            (when (and (pos w78) (closed w78)) (locked w78))  
            (when (and (pos w79) (closed w79)) (locked w79))  
            (when (and (pos w80) (closed w80)) (locked w80))  
            (when (and (pos w81) (closed w81)) (locked w81))  
            (when (and (pos w82) (closed w82)) (locked w82))  
            (when (and (pos w83) (closed w83)) (locked w83))  
            (when (and (pos w84) (closed w84)) (locked w84))  
            (when (and (pos w85) (closed w85)) (locked w85))  
            (when (and (pos w86) (closed w86)) (locked w86))  
            (when (and (pos w87) (closed w87)) (locked w87))  
            (when (and (pos w88) (closed w88)) (locked w88))  
            (when (and (pos w89) (closed w89)) (locked w89))  
            (when (and (pos w90) (closed w90)) (locked w90))  
            (when (and (pos w91) (closed w91)) (locked w91))  
            (when (and (pos w92) (closed w92)) (locked w92))  
            (when (and (pos w93) (closed w93)) (locked w93))  
            (when (and (pos w94) (closed w94)) (locked w94))  
            (when (and (pos w95) (closed w95)) (locked w95))  
            (when (and (pos w96) (closed w96)) (locked w96))  
            (when (and (pos w97) (closed w97)) (locked w97))  
            (when (and (pos w98) (closed w98)) (locked w98))  
            (when (and (pos w99) (closed w99)) (locked w99))  
            (when (and (pos w100) (closed w100)) (locked w100))  
       )
  )
)
