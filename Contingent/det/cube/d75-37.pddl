...
- pos)
  ...
  (:action sense_right
      :observe( (x p75) (not (x p75)))
   ) 	

   (:action sense_left
      :observe( (x p1) (not (x p1)))
   ) 	

  (:action sense_down
      :observe( (y p75) (not (y p75)) )
   ) 	

  (:action sense_up
      :observe( (y p1) (not (y p1)) )
   ) 	

  (:action sense_out
      :observe( (z p75) (not (z p75)))
   ) 	

  (:action sense_in
      :observe( (z p1) (not (z p1)) )
   ) 	



  (:action right
      :precondition (not (x p75))
      :effect
       (and
