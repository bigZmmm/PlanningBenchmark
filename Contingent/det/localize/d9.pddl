...
(define (domain sliding-doors) 
   ...
   (:constants p1-1 p1-2 p1-3 p1-4 p1-5 p1-6 p1-7 p1-8 p1-9 p2-1 p2-2 p2-3 p2-4 p2-5 p2-6 p2-7 p2-8 p2-9 p3-1 p3-2 p3-3 p3-4 p3-5 p3-6 p3-7 p3-8 p3-9 p4-1 p4-2 p4-3 p4-4 p4-5 p4-6 p4-7 p4-8 p4-9 p5-1 p5-2 p5-3 p5-4 p5-5 p5-6 p5-7 p5-8 p5-9 p6-1 p6-2 p6-3 p6-4 p6-5 p6-6 p6-7 p6-8 p6-9 p7-1 p7-2 p7-3 p7-4 p7-5 p7-6 p7-7 p7-8 p7-9 p8-1 p8-2 p8-3 p8-4 p8-5 p8-6 p8-7 p8-8 p8-9 p9-1 p9-2 p9-3 p9-4 p9-5 p9-6 p9-7 p9-8 p9-9 - pos
   ...
   (:action move-up
     ...
     :effect (and (not (ok)) 
       ...
       (when (and  (at p9-1)) (and (at p9-2) (not (at  p9-1))))
       (when (and  (at p1-2)) (and (at p1-3) (not (at  p1-2))))
       (when (and  (at p9-2)) (and (at p9-3) (not (at  p9-2))))
       (when (and  (at p1-3)) (and (at p1-4) (not (at  p1-3))))
       (when (and  (at p9-3)) (and (at p9-4) (not (at  p9-3))))
       (when (and  (at p1-4)) (and (at p1-5) (not (at  p1-4))))
       (when (and  (at p9-4)) (and (at p9-5) (not (at  p9-4))))
       (when (and  (at p1-5)) (and (at p1-6) (not (at  p1-5))))
       (when (and  (at p9-5)) (and (at p9-6) (not (at  p9-5))))
       (when (and  (at p1-6)) (and (at p1-7) (not (at  p1-6))))
       (when (and  (at p9-6)) (and (at p9-7) (not (at  p9-6))))
       (when (and  (at p1-7)) (and (at p1-8) (not (at  p1-7))))
       (when (and  (at p9-7)) (and (at p9-8) (not (at  p9-7))))
       (when (and  (at p1-8)) (and (at p1-9) (not (at  p1-8))))
       (when (and  (at p9-8)) (and (at p9-9) (not (at  p9-8))))
   ))
  (:action move-down
     :precondition (and (ok) (free-down))
     :effect (and (not (ok)) 
       (when (and  (at p1-2)) (and (at p1-1) (not (at  p1-2))))
       (when (and  (at p9-2)) (and (at p9-1) (not (at  p9-2))))
       (when (and  (at p1-3)) (and (at p1-2) (not (at  p1-3))))
       (when (and  (at p9-3)) (and (at p9-2) (not (at  p9-3))))
       (when (and  (at p1-4)) (and (at p1-3) (not (at  p1-4))))
       (when (and  (at p9-4)) (and (at p9-3) (not (at  p9-4))))
       (when (and  (at p1-5)) (and (at p1-4) (not (at  p1-5))))
       (when (and  (at p9-5)) (and (at p9-4) (not (at  p9-5))))
       (when (and  (at p1-6)) (and (at p1-5) (not (at  p1-6))))
       (when (and  (at p9-6)) (and (at p9-5) (not (at  p9-6))))
       (when (and  (at p1-7)) (and (at p1-6) (not (at  p1-7))))
       (when (and  (at p9-7)) (and (at p9-6) (not (at  p9-7))))
       (when (and  (at p1-8)) (and (at p1-7) (not (at  p1-8))))
       (when (and  (at p9-8)) (and (at p9-7) (not (at  p9-8))))
       (when (and  (at p1-9)) (and (at p1-8) (not (at  p1-9))))
       (when (and  (at p9-9)) (and (at p9-8) (not (at  p9-9))))
   ))
 (:action move-left
...
(:action move-right
   ...
   (:action checking
     ...
     :effect (and (ok)
       ...
       (when (and  (not (ok)) (at p9-2)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p1-3)) (and (free-up) (free-right) (free-down) (not (free-left))))
       (when (and  (not (ok)) (at p9-3)) (and (free-up) (free-left) (free-down) (not (free-right))))
       (when (and  (not (ok)) (at p1-4)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p9-4)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p1-5)) (and (free-up) (free-right) (free-down) (not (free-left))))
       (when (and  (not (ok)) (at p9-5)) (and (free-up) (free-left) (free-down) (not (free-right))))
       (when (and  (not (ok)) (at p1-6)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p9-6)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p1-7)) (and (free-up) (free-right) (free-down) (not (free-left))))
       (when (and  (not (ok)) (at p9-7)) (and (free-up) (free-left) (free-down) (not (free-right))))
       (when (and  (not (ok)) (at p1-8)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p9-8)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p1-1)) (and (free-up) (free-right) (not (free-down)) (not (free-left))))
       (when (and  (not (ok)) (at p9-1)) (and (free-up) (free-left) (not (free-down)) (not (free-right))))
       (when (and  (not (ok)) (at p1-9)) (and (free-down) (free-right) (not (free-up)) (not (free-left))))
       (when (and  (not (ok)) (at p9-9)) (and (free-down) (free-left) (not (free-up)) (not (free-right))))
 )) )
