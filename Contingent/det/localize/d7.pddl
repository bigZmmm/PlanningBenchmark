...
(define (domain sliding-doors) 
   ...
   (:action move-up
     ...
     :effect (and (not (ok)) 
       ...
       (when (and  (at p7-1)) (and (at p7-2) (not (at  p7-1))))
       (when (and  (at p1-2)) (and (at p1-3) (not (at  p1-2))))
       (when (and  (at p7-2)) (and (at p7-3) (not (at  p7-2))))
       (when (and  (at p1-3)) (and (at p1-4) (not (at  p1-3))))
       (when (and  (at p7-3)) (and (at p7-4) (not (at  p7-3))))
       (when (and  (at p1-4)) (and (at p1-5) (not (at  p1-4))))
       (when (and  (at p7-4)) (and (at p7-5) (not (at  p7-4))))
       (when (and  (at p1-5)) (and (at p1-6) (not (at  p1-5))))
       (when (and  (at p7-5)) (and (at p7-6) (not (at  p7-5))))
       (when (and  (at p1-6)) (and (at p1-7) (not (at  p1-6))))
       (when (and  (at p7-6)) (and (at p7-7) (not (at  p7-6))))
   ))
  (:action move-down
     :precondition (and (ok) (free-down))
     :effect (and (not (ok)) 
       (when (and  (at p1-2)) (and (at p1-1) (not (at  p1-2))))
       (when (and  (at p7-2)) (and (at p7-1) (not (at  p7-2))))
       (when (and  (at p1-3)) (and (at p1-2) (not (at  p1-3))))
       (when (and  (at p7-3)) (and (at p7-2) (not (at  p7-3))))
       (when (and  (at p1-4)) (and (at p1-3) (not (at  p1-4))))
       (when (and  (at p7-4)) (and (at p7-3) (not (at  p7-4))))
       (when (and  (at p1-5)) (and (at p1-4) (not (at  p1-5))))
       (when (and  (at p7-5)) (and (at p7-4) (not (at  p7-5))))
       (when (and  (at p1-6)) (and (at p1-5) (not (at  p1-6))))
       (when (and  (at p7-6)) (and (at p7-5) (not (at  p7-6))))
       (when (and  (at p1-7)) (and (at p1-6) (not (at  p1-7))))
       (when (and  (at p7-7)) (and (at p7-6) (not (at  p7-7))))
   ))
 (:action move-left
...
(:action move-right
   ...
   (:action checking
     ...
     :effect (and (ok)
       ...
       (when (and  (not (ok)) (at p7-2)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p1-3)) (and (free-up) (free-right) (free-down) (not (free-left))))
       (when (and  (not (ok)) (at p7-3)) (and (free-up) (free-left) (free-down) (not (free-right))))
       (when (and  (not (ok)) (at p1-4)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p7-4)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p1-5)) (and (free-up) (free-right) (free-down) (not (free-left))))
       (when (and  (not (ok)) (at p7-5)) (and (free-up) (free-left) (free-down) (not (free-right))))
       (when (and  (not (ok)) (at p1-6)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p7-6)) (and (free-up) (free-down) (not (free-left)) (not (free-right))))
       (when (and  (not (ok)) (at p1-1)) (and (free-up) (free-right) (not (free-down)) (not (free-left))))
       (when (and  (not (ok)) (at p7-1)) (and (free-up) (free-left) (not (free-down)) (not (free-right))))
       (when (and  (not (ok)) (at p1-7)) (and (free-down) (free-right) (not (free-up)) (not (free-left))))
       (when (and  (not (ok)) (at p7-7)) (and (free-down) (free-left) (not (free-up)) (not (free-right))))
 )) )
